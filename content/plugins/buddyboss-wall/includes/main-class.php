...
class BuddyBoss_Wall_Plugin
{
    ...
    <div class="updated">
	    ...
	    <p class="submit"><a href="<?php echo add_query_arg('disable_wall_legacy_notice', 'true', admin_url('options-general.php?page=buddyboss-wall/includes/admin.php') ); ?>" class="button-primary"><?php _e( 'Disable Notice', 'buddyboss-wall' ); ?></a></p>
    </div>
    <?php
	}
