...
function buddyboss_wall_get_visibility_lists($is_group_activity = false){
    ...
    $options = array(
        'public'	=> __('Everyone', 'buddypress-creative-portfolio-pro'),
        'loggedin'	=> __('Logged In Users', 'buddypress-creative-portfolio-pro'),
    );
    if( $bp_displayed_user_id == $bp_loggedin_user_id || !bp_is_user_activity() ) {
        $options['onlyme'] = __('Only Me', 'buddypress-creative-portfolio-pro');
    }
    if( bp_is_active( 'friends' ) ) {
        $options['friends'] = __('My Friends', 'buddypress-creative-portfolio-pro');
    }
    if( $is_group_activity && bp_is_active( 'groups' ) ) {
        $options['grouponly'] = __('Group Members', 'buddypress-creative-portfolio-pro');
    }
			...
			<form id="form_buddyboss-wall-privacy" method="POST" onsubmit="return buddyboss_wall_submit_privacy();">
				...
				<div class="clearfix" id="buddyboss-wall-privacy">
					...
					<div class="field submit">
						<input type="submit" id="buddyboss-wall-privacy-submit" value="<?php _e( 'Save', 'buddyboss-media' );?>" > &nbsp; 
...
function buddyboss_wall_editing_privacy() {
	...
	if ( ( buddyboss_wall()->is_wall_privacy_enabled() ) && ( bp_get_activity_user_id() == bp_loggedin_user_id() ) ) {
		...
		<?php _e( 'Privacy', 'buddyboss-media' ); ?>
					</a>
		<?php
	}
}
