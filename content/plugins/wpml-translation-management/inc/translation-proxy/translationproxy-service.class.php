...
if ( !class_exists( 'TranslationProxy_Service' ) ) {
	class TranslationProxy_Service implements TranslationProxy_Service_Interface {
...
//			return (10 * $translation_service_id) * $translator_id * -1;
		...
		public static function is_local_translator($translator_id) {
			return is_numeric($translator_id);
		}
