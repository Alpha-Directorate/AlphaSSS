...
global $wp_query, $sitepress, $iclTranslationManagement;
...
if ( ! empty( $current_translator->language_pairs ) ) {
	...
	$job_types        = $iclTranslationManagement->get_translation_job_types(
																	array(
            ...
            <div
                ...
                <?php if ( $page_links ) { ?>
                    ...
                    if ( ! isset( $_GET[ 'show_all' ] ) && $total_count > $args[ 'per_page' ] ) {
                        echo '<a style="font-weight:normal" href="' . admin_url( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/translations-queue.php&show_all=1' ) . '">' . __( 'Show All',
                                                                                                                                                                               'wpml-translation-management' ) . '</a>';
                    }
                    echo $page_links_text; ?>

                <?php } elseif ( $args[ 'per_page' ] > 20 ) {
                    echo '<a style="font-weight:normal" href="' . admin_url( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/translations-queue.php' ) . '">' . __( 'Show 20',
                                                                                                                                                                'wpml-translation-management' ) . '</a>';
                } ?>
            </div>
