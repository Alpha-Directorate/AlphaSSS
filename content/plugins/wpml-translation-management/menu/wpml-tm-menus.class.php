...
class WPML_TM_Menus
{
    ...
    public function build_content_translators() {
        require 'wpml-translator-settings.class.php';
		...
		<a id="your_translators"><h3><?php _e( 'Your Translators', 'wpml-translation-management' ); ?></h3></a>
        <?php $translator_settings->build_content_translators(); ?>
        
		<a id="translation_services"><h3><?php _e( 'Available Translation Services', 'wpml-translation-management' ) ?></h3></a>
    ...
    private function build_translation_options() {
        ...
        if ( $basket_items_number > 0 ) {
            ...
            $basket_name_placeholder = esc_attr( TranslationProxy_Basket::get_unique_basket_name( $basket_name_placeholder, $basket_name_max_length ) );
            ?>
    ...
    private function build_content_dashboard_documents()
    {
        ...
        if (isset($_GET['show_all']) && $_GET['show_all'] && count($this->documents) > ICL_TM_DOCS_PER_PAGE) {
            echo '<a style="float:right" href="' . admin_url('admin.php?page=' . WPML_TM_FOLDER . '/menu/main.php&sm=dashboard') . '">' . sprintf(__('Show %d documents per page', 'wpml-translation-management'), ICL_TM_DOCS_PER_PAGE) . '</a>';
        }
        // pagination
            ...
            <tr>
                <td>
                    <table id="icl_tm_languages" class="widefat" style="width:auto;border: none;">
                        <thead>
                        <tr>
                            <td><strong style="font-size: large">All Languages</strong></td>
                            <td>
                                <input type="radio" id="translate-all" value="1" name="radio-action-all" checked="checked"/> <?php _e( 'Translate',
                                                                   'wpml-translation-management' ) ?>
                            </td>
                            <td>
                                <input type="radio" id="duplicate-all" value="2" name="radio-action-all"/> <?php _e( 'Duplicate content',
                                                                   'wpml-translation-management' ) ?>
                            </td>
                            <td>
                                <input type="radio" id="update-none" value="0" name="radio-action-all"/> <?php _e( 'Do nothing', 'wpml-translation-management' ) ?>
                            </td>
                        </tr>
                        <tr class="blank_row">
                        ...
                        <?php foreach ( $this->active_languages as $lang ): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <?php echo $radio_prefix_html ?> value="1" <?php echo $tr_checked ?>/>
                                        <?php _e( 'Translate', 'wpml-translation-management' ); ?>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <?php echo $radio_prefix_html ?> value="2" <?php echo $du_checked ?>/>
                                        <?php _e( 'Duplicate content', 'wpml-translation-management' ); ?>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <?php echo $radio_prefix_html ?> value="0" <?php echo $no_checked ?>/>
