...
class WPML_Translation_Editor {
	...
	public function __construct( $target_lang, $source_lang, $rtl_original, $rtl_translated ) {
    ...
    public function init_tinymce(){
        echo '<script type="text/javascript">tinyMCE.onAddEditor.add(function (mgr, ed) {
