...
(function () {
	...
	Translation_Jobs_settings.TJ_JS.ns.ready(
		function () {
			...
			var listing_table = new Translation_Jobs.listing.models.ListingTable();

			Translation_Jobs.listing_table_view = new Translation_Jobs.listing.views.ListingTableView({model: listing_table});
