	...
	<span style="padding-left:5em;float:right;">
		<div class="tablenav">
			<div class="tablenav-pages" style="overflow: hidden;white-space: nowrap;">
				<% if( !TJ.show_all ) { %>
					<a id="icl_jobs_show_all" style="font-weight:normal" href="#"><?php _e("show all %s items", 'wpml-translation-management');?></a>
				<%} else {%>
					<a id="icl_jobs_show_all" style="font-weight:normal" href="#"><?php _e("show %s items", 'wpml-translation-management');?></a>
				<% } %>
