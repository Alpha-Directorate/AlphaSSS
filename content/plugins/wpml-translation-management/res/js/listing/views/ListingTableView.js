    ...
    Translation_Jobs.listing.views.ListingTableView = Backbone.View.extend(
        {
            ...
            initialize: function () {
                ...
                self.model.bind(
                    'groups_ready', function () {
                        ...
                        self.model.get('Navigator').bind('pagination_changed', self.renderFilter);
            ...
            renderGroups: function () {
                ...
                if (typeof groups !== 'undefined' && groups.length > 0) {
                    self.groups_view = new Translation_Jobs.listing.views.ListingGroupsView({
                        model: groups,
                        vent: self.vent
                    });
                }
            ...
            renderFilter: function () {
                ...
                if (!self.model.get('old_navigator')) {
                    old_navigator = {
                        page: 1,
                ...
                var filter_view = new Translation_Jobs.listing.views.ListingFilterView({model: filter_options});
                self.filter_view = filter_view;
                filter_view.render();
                filter_fragment.appendChild(filter_view.el);
            ...
            renderNav: function () {
                ...
                var navigator_view = new Translation_Jobs.listing.views.ListingNavigatorView({
                    model: navigator_options,
                    vent: self.vent
                });
                self.navigator_view = navigator_view;
                navigator_view.render();
                jQuery(navigator_view.el).undelegate('#icl_jobs_show_all', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-prev-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-next-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-before-prev-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-after-next-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-first-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-last-page', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-prev-page-arrow', 'click');
                jQuery(navigator_view.el).undelegate('.js-nav-next-page-arrow', 'click');
                navigator_fragment.appendChild(navigator_view.el);
            ...
            cancelJobs: function (e) {
                ...
                self.ajaxLoader = jQuery(icl_ajxloaderimg).insertBefore(jQuery('#icl-tm-jobs-cancel-but'));
