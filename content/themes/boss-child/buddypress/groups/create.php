			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<div>
					<label for="group-name">
						<ul class="list-unstyled">
							<li><?php _e( 'Group Name (required)', 'boss' ); ?></li>
							<li><?php echo tooltip( __( 'Group Name Create Tooltip', 'boss' ) ); ?></li>
						</ul>
					</label>
				...
				<div>
					<label for="group-desc">
						<ul>
							<li><?php _e( 'Group Description (required)', 'boss' ); ?></li>
							<li><?php echo tooltip( __( 'Group Description Create Tooltip', 'boss' ) ); ?></li>
						</ul>
					</label>
			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit" id="previous-next">
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Create My Group and Continue', 'boss' ); ?>" id="group-creation-create" name="save" />
