 ...
 function buddyboss_no_cover_photo($object,$object_id){
   ...
   if(!buddyboss_cover_photo_can_edit($object,$object_id)) {
    ...
    <div class="bb-cover-photo no-photo" data-obj="'.$object.'" data-objid="'.$object_id.'">
      <button class="update-cover-photo" title="'.__("Ideal size: 1050x320px","boss").'" id="update-cover-photo-btn"><i class="fa fa-picture-o"></i><div> '.__("Update Cover Photo","boss").'<i class="fa fa-spinner fa-spin" style="display:none"></i></div></button>
      <div class="progress"><span></span></div>
    </div>'.
