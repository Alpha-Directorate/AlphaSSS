			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<script type="text/javascript">
					jQuery(document).ready(function($) {
						...
						$("#about-count").text((140 - $('#group-desc').val().length) + " <?php _e('characters left', 'alphasss'); ?>" )

						$("#group-desc").keydown(function(){
							$("#about-count").text((140 - $(this).val().length) + " <?php _e('characters left', 'alphasss'); ?>" );
						});
				...
				<div>
					<label for="group-name">
						<ul class="list-unstyled">
							<li><?php _e( 'Group Name (required)', 'buddypress' ); ?></li>
							<li><?php echo tooltip( __( 'Group Name Create Tooltip', 'buddypress' ) ); ?></li>
						</ul>
					</label>
				...
				<div>
					<label for="group-desc">
						<ul>
							<li><?php _e( 'Group Description (required)', 'buddypress' ); ?></li>
