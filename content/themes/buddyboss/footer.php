        ...
        <div class="footer-inner">
            ...
            <div id="footer-links">
                ...
                <p class="footer-credits <?php if ( !has_nav_menu( 'secondary-menu' ) ) : ?>footer-credits-single<?php endif; ?>">
                    <?php _e( "Copyright &copy;", 'buddyboss' ); ?> <?php echo date('Y'); ?> <?php bloginfo('name'); ?> <?php _e( '&nbsp;&middot;&nbsp; Designed by <a href="http://www.buddyboss.com/" target="_blank" title="responsive BuddyPress theme">BuddyBoss</a>', 'buddyboss' ); ?>
                </p>
