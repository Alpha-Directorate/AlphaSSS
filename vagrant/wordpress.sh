...
then
	...
	sudo cp /vagrant/vagrant/etc/apache2/sites-available/alpha-social.dev.conf /etc/apache2/sites-available

	sudo a2ensite alpha-social.dev

	sudo cp /vagrant/vagrant/var/www/alpha-social.dev/local-config.php /var/www/alpha-social.dev/local-config.php
